...
import FloatingBoxesRain from '../animations/FloatingBoxesRain';
...
const Signup: React.FC = () => {
    ...
    return (
        <div className="min-h-screen bg-light-bg flex items-center justify-center p-4 relative overflow-hidden">
            {/* Floating Boxes Background - Fixed positioning */}
            <FloatingBoxesRain intensity="medium" className="z-0" />
            ...
            <div className="w-full max-w-md relative z-10">
                            ...
                            <div className="flex items-center w-full px-4 py-2.5 border border-gray-300 rounded-lg focus-within:ring-2 focus-within:ring-primary-blue">
                                <Controller
                                    ...
                                    rules={{ 
                                        ...
                                        validate: value => isPossiblePhoneNumber(String(value)) || "Invalid phone number" 
                                    }}
                                    render={({ field }) => (
                ...
                <p className="text-center mt-6 text-sm text-light-text relative z-10">
                    ...
                    <NavLink to="/login" className="font-medium text-primary-blue hover:underline">
                        Log in
                    </NavLink>
                </p>
            </div>
