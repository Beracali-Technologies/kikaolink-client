...
const RegistrationSuccessPage: React.FC = () => {
  ...
  // Strongly type the registrationData
  const registrationData = location.state?.registrationData as RegistrationResponse | undefined;

  if (!registrationData) {
    return (
      <div className="p-6 text-center">
        <h1 className="text-2xl font-bold text-red-600">No registration data found</h1>
  ...
  const { registration, qr_code_url } = registrationData.data;
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex items-center justify-center relative overflow-hidden">
      ...
      <div className="max-w-md mx-auto p-6 text-center relative z-10">
        ...
        {/* QR code + registration details */}
        <div className="grid md:grid-cols-2 gap-8">
          <QrCodeDisplay
            qrCodeUrl={qr_code_url}
            registrationCode={registration.unique_code}
          />
          ...
          <div className="space-y-4">
            <div className="bg-blue-50 p-4 rounded-lg">
              ...
              <div className="space-y-2 text-sm">
                ...
                <p><span className="font-medium">Status:</span> <span className="text-green-600 font-medium">{registration.status}</span></p>
              </div>
            </div>
